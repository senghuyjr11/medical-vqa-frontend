        ...
        <div className="p-6 space-y-5 max-w-4xl mx-auto w-full">
            {messages.length === 0 && (
                <div className="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <p className="text-gray-700 font-medium">Ask a clinical question</p>
                    <p className="text-gray-400 text-sm mt-1">You can also attach a medical image for visual analysis</p>
                </div>
            )}
            ...
            {messages.map((m, idx) => {
                ...
                return (
                    <div key={idx} className={`flex gap-3 ${isUser ? "flex-row-reverse" : "flex-row"}`}>
                        ...
                        {/* Bubble */}
                        <div className={`max-w-2xl px-4 py-3 rounded-2xl whitespace-pre-wrap leading-relaxed text-sm shadow-sm ${
                            isUser
